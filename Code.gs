 ...
 *     translation.
 */
function getTextAndTranslation(blogtitle, category) {
  Logger.log("test" + blogtitle);
  Logger.log("category" + category);
  var text = getSelectedText();
	 //result['text'] = text.join('\n');
  var payload = {title:blogtitle,content:text.join('\n'),category_id: category,frontpage:1};
  // Replace with raw video data.
  var url = 'http://demo.appcarvers.com/junite/index.php?option=com_api&format=raw&app=easyblog&resource=blog&key=c2ecb0c473849018bf97b67302f42caebc08ee1e';
  var options = {
    'method': 'post',
    'payload': payload
  };
